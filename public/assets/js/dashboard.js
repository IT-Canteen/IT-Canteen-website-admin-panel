(function($) {
    ...
    $(function() {
      ...
      if ($("#transaction-history").length) {
        var areaData = {
          labels: ["Activities", "News","Vlogs","Registered Count"],
          datasets: [{
              data: [$("#activitiesCount").text(), $("#newsCount").text(), $("#vlogsCount").text()],
              backgroundColor: [
        ...
        var transactionhistoryChartPlugins = {
          beforeDraw: function(chart) {
            ...
            var text = parseInt($("#activitiesCount").text())+parseInt($("#newsCount").text())+parseInt($("#vlogsCount").text()), 
